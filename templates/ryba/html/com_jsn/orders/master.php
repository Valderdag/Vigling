...
<div class="jsn-p">
	...
	<?php else:?>
		...
		<?php foreach($this->items as $i=>$order){
            ...
            $user_m = JsnHelper::getUser($order->user_id);
			...
			?>
			<div id="row" class="row<?= $add_class ?>" style="padding: 6px 0;" id="<?= $order->time ?>" >
				...
				<div class="col-xs-6 col-sm-7 col-md-2"><a href="<?php echo $user_m->getLink();?>"><?php echo $order->user_name;?></a></div>
