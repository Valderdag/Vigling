...
?>
<!-- Modal  THIS ORDER-->
<div class="modal fade" id="rplStock" role="dialog" name="master" aria-labelledby="exampleModalLabel"   aria-hidden="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="rplStock-form" method="POST" action="/">
					...
					<input type="hidden"  class="svc_cat" name="svc_cat" value=""/>
...
<!-- Modal DELETE-->
<div class="modal fade" id="delStock" role="dialog" aria-labelledby="exampleModalLabel" tabindex="-1"  aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<h2>Отмена записи</h2>
				<form id="delStock-form" method="POST" action="/">
					<div class="del__btn">
